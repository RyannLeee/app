...
import cc.yuanlee.labtalk.runtimepermissions.PermissionsManager;
import cc.yuanlee.labtalk.runtimepermissions.PermissionsResultAction;
...
public class MainActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//register broadcast receiver to receive the change of group from AppHelper
...
//				Toast.makeText(MainActivity.this, "All permissions have been granted", Toast.LENGTH_SHORT).show();
	...
	protected void onResume() {
		...
		// background
		AppHelper sdkHelper = AppHelper.getInstance();
