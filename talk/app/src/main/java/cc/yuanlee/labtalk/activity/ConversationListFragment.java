...
import cc.yuanlee.easeui.ui.EaseConversationListFragment;
...
public class ConversationListFragment extends EaseConversationListFragment{
    ...
    protected void initView() {
        super.initView();
        View errorView = (LinearLayout) View.inflate(getActivity(),R.layout.neterror_item, null);
                ...
                if (username.equals(EMClient.getInstance().getCurrentUser()))
                    ...
                    if(conversation.isGroup()){
                        if(conversation.getType() == EMConversationType.ChatRoom){
                            // it's group chat
                            intent.putExtra(Constant.EXTRA_CHAT_TYPE, Constant.CHATTYPE_RESEARCHROOM);
                        }else{
