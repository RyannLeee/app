...
import cc.yuanlee.easeui.EaseUI;
import cc.yuanlee.easeui.EaseUI.EaseEmojiconInfoProvider;
import cc.yuanlee.easeui.EaseUI.EaseSettingsProvider;
import cc.yuanlee.easeui.EaseUI.EaseUserProfileProvider;
import cc.yuanlee.easeui.domain.EaseAvatarOptions;
import cc.yuanlee.easeui.domain.EaseEmojicon;
import cc.yuanlee.easeui.domain.EaseEmojiconGroupEntity;
import cc.yuanlee.easeui.domain.EaseUser;
import cc.yuanlee.easeui.model.EaseAtMessageHelper;
import cc.yuanlee.easeui.model.EaseNotifier;
import cc.yuanlee.easeui.model.EaseNotifier.EaseNotificationInfoProvider;
import cc.yuanlee.easeui.utils.EaseCommonUtils;
import cc.yuanlee.labtalk.activity.ChatActivity;
import cc.yuanlee.labtalk.activity.MainActivity;
...
import cc.yuanlee.labtalk.receiver.CallReceiver;
...
public class AppHelper {
    ...
    private EMOptions initChatOptions(){
         ...
         */
        options.setFCMNumber("645061626497");
        //you need apply & set your own id if you want to use Mi push notification
        options.setMipushConfig("2882303761517793335", "5621779318335");
                ...
                if(isVideoCalling){
                    ...
                    if (chatType == ChatType.Chat) { // single chat message
                        ...
                        if(chatType == ChatType.GroupChat){
                            ...
                            intent.putExtra("chatType", Constant.CHATTYPE_RESEARCHROOM);
                        }
    ...
    protected void setGlobalListeners(){
        ...
        isGroupsSyncedWithServer = appModel.isGroupsSynced();
        isContactsSyncedWithServer = appModel.isContactSynced();
        isBlackListSyncedWithServer = appModel.isBacklistSynced();
...
//                break;
    ...
    public void setCurrentUserName(String username){
    	...
    	appModel.setCurrentUserName(username);
    }
    ...
    public String getCurrentUsernName(){
    	if(username == null){
    		username = appModel.getCurrentUsernName();
    	}
    	return username;
    }
    ...
    public void updateContactList(List<EaseUser> contactInfoList) {
         ...
         appModel.saveContactList(mList);
    }
       ...
       new Thread(){
           ...
           public void run(){
               try {
                   ...
                   appModel.setGroupsSynced(false);
                   isGroupsSyncedWithServer = false;
                   isSyncingGroupsWithServer = false;
                   noitifyGroupSyncListeners(false);
                   if(callback != null){
           ...
           public void run(){
               ...
               try {
                  ...
                  if (selfIds.size() > 0) {
                   ...
                   appModel.setContactSynced(true);
                   ...
                   appModel.setContactSynced(false);
                   isContactsSyncedWithServer = false;
                   isSyncingContactsWithServer = false;
                   notifyContactsSyncListener(false);
                   e.printStackTrace();
       ...
       new Thread(){
           ...
           public void run(){
               try {
                   ...
                   appModel.setBlacklistSynced(true);
                   ...
                   appModel.setBlacklistSynced(false);
