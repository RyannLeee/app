...
import cc.yuanlee.easeui.ui.EaseGroupListener;
...
public class GroupDetailsActivity extends BaseActivity implements OnClickListener {
	...
	public static final int RESULT_CODE_MISSION_PUBLISH = 5;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// Group notification
		RelativeLayout missionPubLayout = (RelativeLayout) findViewById(R.id.layout_mission_publish);
        if(group.getOwner().equals(EMClient.getInstance().getCurrentUser()) ||
            ...
            missionPubLayout.setVisibility(View.VISIBLE);
        } else {
            missionPubLayout.setVisibility(View.GONE);
        }
		...
		membersAdapter = new GridAdapter(this, R.layout.grid_owner, new ArrayList<String>());
		EaseExpandGridView userGridview = (EaseExpandGridView) findViewById(R.id.gridview);
		userGridview.setAdapter(membersAdapter);

		ownerAdminAdapter = new OwnerAdminAdapter(this, R.layout.grid_owner, new ArrayList<String>());
		...
		missionPubLayout.setOnClickListener(this);
	}
	...
	private void refreshMembersAdapter() {
		runOnUiThread(new Runnable() {
			...
			public void run() {
				...
				membersAdapter = new GridAdapter(GroupDetailsActivity.this, R.layout.grid_owner, new ArrayList<String>());
	...
	public void onClick(View v) {
		switch (v.getId()) {
			...
			case R.id.layout_mission_publish:
				setResult(RESULT_CODE_MISSION_PUBLISH);
				finish();
				break;
			default:
				break;
