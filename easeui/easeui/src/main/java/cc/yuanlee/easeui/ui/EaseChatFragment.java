...
import cc.yuanlee.easeui.widget.EaseChatExtendMenu;
import cc.yuanlee.easeui.widget.EaseChatInputMenu;
import cc.yuanlee.easeui.widget.EaseChatMessageList;
import cc.yuanlee.easeui.widget.EaseVoiceRecorderView;
...
//        messageList.setAvatarShape(1);
    ...
    protected void setUpView() {
        ...
        if (chatType != EaseConstant.CHATTYPE_RESEARCHROOM) {
            onConversationInit();
            onMessageListInit();
        }
    ...
    protected void sendMessage(EMMessage message){
        ...
        }else if(chatType == EaseConstant.CHATTYPE_RESEARCHROOM){
